...
function createSpiral(int $size): array {
    $spiral = [];
    for ($x = 0; $x < $size; $x++) {
        $spiral[$x] = [];
        for ($y = 0; $y < $size; $y++) {
...
function fillSpiral(array $spiral): array {
    ...
    while ($filled == false) {
        ...
        if ($direction === 'u') {
            ...
            if ((isset($spiral[$y - 1][$x]) === false || $spiral[$y - 1][$x] !== 0) && isset($spiral[$y][$x + 1]) === false || $spiral[$y][$x+1] !== 0) {
                $filled = true;
            }
        }
        ...
        if ($direction === 'r') {
            ...
            if ((!isset($spiral[$y][$x + 1]) || $spiral[$y][$x+1] !== 0) && (isset($spiral[$y + 1][$x]) === false || $spiral[$y + 1][$x] !== 0)) {
                $filled = true;
            }
        }
        ...
        if ($direction === 'l') {
            ...
            if ((isset($spiral[$y][$x-1]) === false || $spiral[$y][$x-1] !== 0) && isset($spiral[$y - 1][$x]) === false || $spiral[$y - 1][$x] !== 0) {
                $filled = true;
            }
        }
...
function calculateCross(array $spiral, int $maxSize): int {
    $alreadyAdded = [];
    $sum = 0;
    $y = $maxSize -1;
